...
NodeCG.dashboardPanels = { replicant: {}, replicantValues: {}, panels: [] };
NodeCG.masterRunList = { replicant:{}, replicantValues:{}, schedule: { order: [], missing: []} }
...
NodeCG.prototype.unlisten = function(messageName, bundleName, handlerFunc) {
	...
	const index = this._messageHandlers.findIndex(handler => {
		return handler.messageName === messageName && handler.bundleName === bundleName && handler.func === handlerFunc;
	});
