...
(function(root, factory) {
  ...
  function animate(params = {}) {
    ...
    instance.tick = function(t) {
      ...
      const engineTime = (lastTime + now - startTime) * animate.speed;
  ...
  animate.version = '2.0.2';
  animate.speed = 1;
  animate.running = activeInstances;
  animate.remove = removeTargets;
  animate.getValue = getOriginalTargetValue;
  animate.path = getPath;
  animate.setDashoffset = setDashoffset;
  animate.bezier = bezier;
  animate.easings = easings;
  animate.timeline = timeline;
  animate.random = (min, max) => Math.floor(Math.random() * (max - min + 1)) + min;
